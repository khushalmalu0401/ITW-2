...
root.iconbitmap("C:\\COLLEGE WORK\\SEMESTER 4\\IT WORKSHOP(PYTHON)\\PBL\\Clock.ico")
myimg = ImageTk.PhotoImage(Image.open('C:\\COLLEGE WORK\\SEMESTER 4\\IT WORKSHOP(PYTHON)\\PBL\\bg.jpg'))
